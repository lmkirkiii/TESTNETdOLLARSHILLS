        ...
        :
          <div className="no-wallet">
            ...
            <div className="use-block-explorer">
              <h2>Whats all the Hubbub about Dollar Shillz</h2>
              This freak project is just the solution we need to a global recession a t <strong>massive attack print of fiercely unique monay</strong>!!!!! <span className="emoji">🔥🔥🔥🔥🔥</span><br />
              We want you all to become shillionaires with us and ball it all the way to the moon.<strong>George Washington</strong> once said letssss fuckinnng go and the USA was born! Let's make a new kind of liberty with the shillz thrillz and billz that this project is all about.
              <br />
              Lets go where no NFT has gone before muahahaha <span className="emoji">🚀</span>
            </div>
